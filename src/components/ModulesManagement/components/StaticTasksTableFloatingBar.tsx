...
import BulkDeleteModulesDialog from "../CRUD/BulkDeleteModulesDialog";
            ...
            <div className="mx-auto flex w-fit items-center gap-2 rounded-md border bg-background p-2 text-foreground shadow">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <BulkDeleteModulesDialog
                  ...
                  description="Are you sure you want to delete the selected modules? This action cannot be undone."
                  selectedModuleIds={selectedRowIds as Id<"modules">[]}
