...
export function PermissionsSelector({
  ...
  const permissions = useQuery(api.queries.permissions.fetchAllPermissions);
        ...
        >
          <Checkbox
            ...
            checked={selectedPermissions.includes(
              permission._id as Id<"permissions">
            )}
            onCheckedChange={() =>
              onPermissionChange(permission._id as Id<"permissions">)
            }
