                        ...
                        <div className="mx-auto flex w-fit items-center gap-2 rounded-md border bg-background p-2 text-foreground shadow">
                            ...
                            <div className="flex items-center gap-1.5">
                                ...
                                <BulkDeleteDialog
                                    ...
                                    description="Are you sure you want to delete the selected chapters? This action cannot be undone."
                                    selectedChapterIds={selectedRowIds} // Pass the selected chapter IDs
