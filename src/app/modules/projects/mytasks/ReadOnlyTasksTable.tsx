...
type ReadOnlyTasksTableProps = {
    tasks: Task[];
    projectId?: Id<"projects">;
};

// Simple floating bar for read-only operations
function ReadOnlyTasksTableFloatingBar({ 
    selectedCount, 
    onClearSelection 
}: { 
...
export function ReadOnlyTasksTable({ tasks, projectId }: ReadOnlyTasksTableProps) {
