...
export function UserTasksList() {
        ...
        return (
            <div className="flex justify-center items-center py-10">
                <EmptyState
                    ...
                    description="You don't have any tasks assigned across all projects."
    ...
    const pageCount = Math.ceil(userTasks.length / pageSize);
    const startIndex = pageIndex * pageSize;
    const endIndex = Math.min(startIndex + pageSize, userTasks.length);
        ...
        <>
            ...
            <div className="mt-6 flex flex-col items-center justify-between gap-4 text-sm">
                <div className="text-muted-foreground">
                    Showing {startIndex + 1} to {endIndex} of {userTasks.length} tasks
                </div>
