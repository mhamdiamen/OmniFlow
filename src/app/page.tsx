  ...
  return (
    <AdminPanelLayout>
      <ContentLayout title="Recent Stories">
        {me?.role === "admin" && <Card className="w-96 h-64 flex items-center justify-center">Hello Admin</Card>}
        {me?.role === "read" && <Card className="w-96 h-64 flex items-center justify-center">Hello Reader</Card>}
        {me?.role === "write" && (
          <>
      ...
      {isLoading ? (
        ...
        <Button variant="outline" onClick={() => setShowSettingsDialog(true)}>Settings</Button>
      ) : (
        <Button variant="outline" onClick={() => setShowDialog(true)}>Create Company</Button>
      )}
